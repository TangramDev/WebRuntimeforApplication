...
__declspec(dllexport) int __stdcall InitApp(bool bSupportCrashReporting) {
  ...
  typedef CommonUniverse::CCosmosMainDllLoader*(__stdcall * SetMainDllLoader)(
      CommonUniverse::CCosmosMainDllLoader * pLoader);
  ...
  if (pSetMainDllLoader != NULL) {
    pSetMainDllLoader(
        (CommonUniverse::CCosmosMainDllLoader*)MakeMainDllLoader());
  }
  return 0;
}
