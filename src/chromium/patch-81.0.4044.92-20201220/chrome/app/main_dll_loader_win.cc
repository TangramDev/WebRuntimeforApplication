...
int MainDllLoader::Launch(HINSTANCE instance,
  ...
  {
	  delete g_pCosmosImpl->m_pBrowserFactory;
	  g_pCosmosImpl->m_pBrowserFactory = nullptr;
  }
  // end Add by TangramTeam
  OnBeforeExit(file);
  return rc;
...
class ChromiumDllLoader : public MainDllLoader {
 protected:
	 ...
	 void LaunchEx(CommonUniverse::CCosmosImpl* pTangramImpl) override
	 {
		 g_pCosmosImpl = pTangramImpl;
